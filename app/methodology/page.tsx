      ...
      <main id="main-content" tabIndex={-1} className="mx-auto max-w-3xl px-6 py-14 sm:py-20">
        ...
        <div className="mt-14 space-y-12">
          ...
          <Section n="02" title="What we measure">
            ...
            <p>
              Each area is measured by a small set of questions answered on a 1 to 10 scale. Every
              question is{' '}
              <strong className="text-ink">anchored</strong>, with the 1, the middle, and the 10 each
              described in words, so a &ldquo;7&rdquo; means the same thing to everyone answering.
              Questions are also tagged as <strong className="text-ink">belief</strong>{' '}(&ldquo;what
              you think is true&rdquo;) or <strong className="text-ink">evidence</strong>{' '}(&ldquo;what&rsquo;s
              actually happening&rdquo;). That distinction powers the blind-spot check later on.
            </p>
          </Section>

          <Section n="03" title="How a score is formed">
            <p>
              An area&rsquo;s raw answers are averaged and rescaled to a familiar 0 to 100 range. But
              a simple average has a well-known flaw: some people rate everything harshly and some
              rate everything generously, so a score can say more about who answered than about the
              ministry itself.
            </p>
            <p>
          ...
          <Section n="05" title="The chain and its dependencies">
            ...
            <ul className="my-2 space-y-2 border-l-2 border-line pl-4">
              ...
              <li>
                ...
                weak upstream, so you&rsquo;re running on borrowed time.
              </li>
              <li>
                <strong className="text-ink">Solid</strong>: both ends are strong, so there&rsquo;s
                nothing to flag.
              </li>
            </ul>
          </Section>

          <Section n="06" title="Blind spots: belief vs evidence">
            <p>
              ...
              supports. When the{' '}
              <strong className="text-ink">evidence runs ahead of belief</strong>, you may be
              underrating yourselves and missing a real strength.
            </p>
            <p>
          ...
          <Section n="07" title="Agreement and confidence">
            <p>
              Before we ask whether your team genuinely disagrees about an area, we first remove each
              person&rsquo;s rating style, so one habitually harsh rater doesn&rsquo;t look like
              conflict when there is none. What&rsquo;s left is{' '}
              <strong className="text-ink">real disagreement</strong>, and we flag it when it&rsquo;s
              meaningful, because a split team often signals an area worth a closer look.
            </p>
            <p>
              We also lower our stated{' '}
              <strong className="text-ink">confidence</strong>{' '}when an area rests on very few
              responses. A verdict built on two answers is treated more cautiously than one built on
              twenty.
            </p>
          </Section>

          <Section n="08" title="The role of AI">
            <p>
              This matters, so we&rsquo;ll be direct. Every score, constraint, and verdict is decided
              by a <strong className="text-ink">deterministic engine</strong>: fixed rules and math
              that produce the same answer every time from the same answers.
            </p>
            <p>
              AI is used only to{' '}
              <strong className="text-ink">rephrase findings that are already decided</strong>{' '}into
              readable prose, and its wording is fact-checked back against the numbers. No model ever
              changes a score or a verdict. The diagnosis is the math; the AI just helps it read like
              a person wrote it.
            </p>
          </Section>

          <Section n="09" title="Versioning and honesty">
            <p>
              This methodology is <strong className="text-ink">versioned</strong>, and we treat its
              thresholds and benchmarks as tunable: they&rsquo;re being refined as more churches take
              the assessment and more real data comes in. We&rsquo;d rather tell you that openly than
              pretend the model is finished.
            </p>
            <p>
        ...
        <div className="mt-14 rounded-2xl border border-line bg-sand/50 p-6 sm:p-8">
          ...
          <p className="mt-3 max-w-[52ch] font-body text-ink-soft">
            Book a free call with the XP Gathering team, and we&rsquo;ll walk through your diagnosis
